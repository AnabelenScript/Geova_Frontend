...
import { useDarkMode, getLoginBackgroundClasses, getLoginContainerClasses } from '../../utils/ui/DarkMode';
...
function Login() {
  ...
  const backgroundProps = getLoginBackgroundClasses(darkMode, '/src/assets/fondo_login.png');
  ...
  return (
    <>
      <DarkModeButton />
      <div {...backgroundProps}>
        <div className="relative z-20 transition-all duration-300" style={{ filter: darkMode ? 'none' : 'invert(1)' }}>
          <div className={containerProps.className} style={containerProps.style}>
            ...
            `}>
              {isLogin && (
                <img src={maquinaImg} alt="Máquina" className="w-full h-auto object-contain" />
              )}
            </div>
            <div className={`
